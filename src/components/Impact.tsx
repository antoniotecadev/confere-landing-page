...
const stats = [
  { value: "127.000 Kz", label: "Economizados em média", emoji: "💰", color: "text-success" },
  { value: "1 em 4", label: "Compras têm erros", emoji: "📊", color: "text-warning" },
  { value: "98%", label: "Dos erros detectados", emoji: "✓", color: "text-primary" },
];
